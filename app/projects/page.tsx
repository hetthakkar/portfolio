        ...
        <div>
          <div className="card-text mt-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/savanthakkar/"
            >
              Savan
            </a>{" "}
            and I missed playing this game with the family, decided to make a
            virtual substitute while in quarantine. A lot of people resonated
            with the idea with the game gaining quite a bit of popularity with
            many feature requests positive feedback from the community pouring
            in. It is available for download{" "}
            <Link
              href="https://judgementcard.games/download"
              target="_blank"
              className="link"
